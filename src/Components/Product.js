...
function Product() {
    ...
    const getProducts = async () => {
        const getMobiles = await axios.get('https://63f2f6b7de3a0b242b37e08b.mockapi.io/mobile')
            ...
            <div className='row'>
                {
                    Products.map((item)=>{
                        ...
                        <div class="card bg-light shadow-sm p-3 mb-5 bg-body rounded position-relative">
